...
module.exports = function attachHandlers (router) { 
    ...
    // isAuthenicatedReqest ensures user is admin (only admin users can be authenticated)
...
{ 
    db.getAll({}, config.connString, config.dbCollectionNamePrefix, function(data){
        res.json(data);
    });
}
...
{ 
    db.getById(req.params.id, config.connString,config.dbCollectionNamePrefix, function(data){
        res.json(data);
    });
} 
...
{  
    ...
    db.upsertPermalink(dataToStore, config.connString,config.dbCollectionNamePrefix, function(err, data){
